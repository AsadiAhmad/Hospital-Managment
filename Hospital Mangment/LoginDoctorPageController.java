...
public class LoginDoctorPageController {
    ...
    public void onClickSignInButton () throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("myFXMLFile/sign_in_doctor_page.fxml"));
    ...
    public void onClickLogInButton () throws IOException {
        ...
        myTool.audioPlayer ("src/Project1/myAudio/click.wav");
        Stage primaryStage = (Stage) login_page_label.getScene().getWindow();
        Parent root = FXMLLoader.load(getClass().getResource("myFXMLFile/log_in_doctor_page.fxml"));
        Scene myScene = new Scene (root);
        myScene.setFill (Color.TRANSPARENT);
        primaryStage.setScene (myScene);
        primaryStage.show();
