...
public class SurgeryPageController {
    public Label surgery_section_label;
    public TextField patient_national_code_text_field;
    public TextField patient_status_text_field;
    public TextField cost_of_surgery_text_field;
    public TextField time_of_surgery;
    public TextArea description_of_surgery_text_field;
    ...
    public int getData () {
        ...
        data.add (cost_of_surgery_text_field.getText());
        data.add (time_of_surgery.getText());
        data.add (description_of_surgery_text_field.getText());
        int result1 = doctor.writeSurgeryData ("src/Project1/myFile/Surgery.txt", data);
        return result1;
    }
    ...
    public String[] arrayOfString () {
        ...
        text[2] = cost_of_surgery_text_field.getText();
        text[3] = time_of_surgery.getText();
        text[4] = description_of_surgery_text_field.getText();
        return text;
    }
    ...
    public void onClickAcceptButton () {
        ...
        if (result6 == 0) { // if text field empty
            int result4 = doctor.createFile("src/Project1/myFile/Surgery.txt");
    ...
    public void onClickCancelButton () throws IOException {
        ...
        Stage primaryStage = (Stage) surgery_section_label.getScene().getWindow();
